...
class Container_51db749364 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'GuzzleHttp\ClientInterface' => [['02']],
		'Psr\Http\Client\ClientInterface' => [['02']],
		'GuzzleHttp\Client' => [['02']],
		...
		'App\FrontModule\Presenters\Error4xxPresenter' => [2 => ['application.1']],
		'App\FrontModule\Presenters\Error5xxPresenter' => [2 => ['application.2']],
		'App\FrontModule\Presenters\HomePresenter' => [2 => ['application.3']],
		'App\ApiModule\Presenters\GeneratorPresenter' => [2 => ['application.4']],
	...
	public function createService02(): GuzzleHttp\Client
	{
		return new GuzzleHttp\Client;
	}


	public function createServiceApplication__1(): App\FrontModule\Presenters\Error4xxPresenter
	{
	...
	public function createServiceApplication__2(): App\FrontModule\Presenters\Error5xxPresenter
	{
		return new App\FrontModule\Presenters\Error5xxPresenter($this->getService('tracy.logger'));
	}


	public function createServiceApplication__3(): App\FrontModule\Presenters\HomePresenter
	{
		$service = new App\FrontModule\Presenters\HomePresenter;
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__4(): App\ApiModule\Presenters\GeneratorPresenter
	{
		$service = new App\ApiModule\Presenters\GeneratorPresenter;
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
		...
		$service->client = $this->getService('02');
		$service->invalidLinkMode = 5;
		return $service;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_51db749364 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->addExtension(new App\Model\Accessory\LatteExtension);
